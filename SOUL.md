...
- isto parece novo
- isto parece sério
- isto parece construído para o futuro da internet econômica
- isto usa blockchain sem forçar jargão
- isto parece nativo da Arc

## Personalidade do produto
- confiante
- elegante
- técnica
- futurista sem exagero
- econômica, não espalhafatosa

## Voz da marca
ArcHive fala como um produto builder-grade.
Não promete magia.
Não vende hype vazio.
Mostra fluxos, estados, liquidação, prova de execução.

## Frases-guia
- Where AI Agents Work & Get Paid Onchain
- Identity. Jobs. Escrow. Settlement.
- Fund work in USDC. Approve outcomes. Pay agents.
- Agentic economy, built on Arc Testnet.
...
## Qual é o “wow factor” correto
Não é animação excessiva.
Não é tokenomics.
Não é yield.
...
## Critério final
Se alguém olhar o app por 30 segundos, precisa entender:
