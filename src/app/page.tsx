...
const routeSteps = [
  ...
  { number: 1, label: "Funded", detail: "USDC escrow locked" },
  { number: 2, label: "Accepted", detail: "Agent commits" },
  { number: 3, label: "In Progress", detail: "Work underway" },
  { number: 4, label: "Submitted", detail: "Hash delivered" },
